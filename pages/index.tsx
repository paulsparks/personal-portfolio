          ...
          items={[
            {
              children: <>
                ...
                <h2 className={sourceCodePro.className + " text-xl"}>Resource Map</h2>
                ...
                <Collapse accordion className="mt-5 text-lg" items={resourceMap} />

                <h2 className={sourceCodePro.className + " text-xl mt-10"}>LHS Live Chat</h2>
                <p className={sourceCodePro.className + " mt-4 text-sm"}>
                ...
                <Collapse accordion className="mt-5 text-lg mb-10" items={lhsLiveChat} />
              </>,
            ...
            },
            {
              ...
              <h2 className={sourceCodePro.className + " text-xl"}>High School Website Vulnerability Report</h2>
              <p className={sourceCodePro.className + " mt-4 text-sm"}>
